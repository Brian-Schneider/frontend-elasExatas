        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>
              ...
              conquistou uma vaga em uma prestigiada escola de ensino médio para
              meninas, que desenvolvia “Talentos Excepcionais”.
            </Typography>
            <Typography paragraph>
            ...
            <Typography paragraph>
              Se formou em matemática na Sharif University no Teerã em 1999 e
              fez pós-graduação na universidade de Harvard. Foi lá que, durante
              um seminário, ela se encantou com um assunto específico: a
              geometria hiperbólica, que se baseia em superfícies em forma de
              "rosquinha" com dois ou mais orifícios, que não seguem um padrão
              geométrico.
            </Typography>
            <Typography paragraph>
              Mirzakhani foi professora de matemática na Universidade de
              Stanford e muitos especialistas do ramo a consideram brilhante,
              pois suas pesquisas se conectam a muitas áreas da matemática,
              incluindo geometria diferencial, análise complexa e sistemas
              dinâmicos. Seu trabalho resultou em diversos artigos publicados
              nas principais revistas de matemática do mundo.
            </Typography>
            <Typography>
              Em 2014, ela foi premiada com a Medalha Fields, por “suas
              excepcionais contribuições à dinâmica e à geometria de superfícies
              de Riemann e seus espaços de Moduli”. O prêmio é considerado como
              a maior honraria que uma pessoa do ramo pode receber. Tanto é
              verdade, que costuma ser chamada de “Prêmio Nobel da Matemática“.
            </Typography>
          </CardContent>
        </Collapse>
      </Card>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>
              ...
              criança se mudou para Chicago onde frequentou a escola-laboratório
              da Universidade de Chicago. Ghez queria ser inicialmente uma
              bailarina, porém o pouso na lua a inspirou a querer tornar-se a
              primeira mulher astronauta e sua mãe apoiou esta decisão, além de
              sua professora ginasial de química. Começou a estudar matemática,
              mas logo depois mudou seus interesses para física.
            </Typography>
            <Typography paragraph>
              Obteve um bacharelado em física no Instituto de Tecnologia de
              Massachusetts (MIT) em 1987 e obteve seu Ph.D. em 1992 no
              Instituto de Tecnologia da Califórnia (Caltech). Suas pesquisas
              atuais envolvem o uso de técnicas de imagem de alta resolução
              espacial para estudar regiões de formação de estrelas e buracos
              negros supermaciços. A maneira de "ver" um buraco negro, por
              definição invisível, é observar os objetos que giram entorno e
              revelam a presença do gigante.
            </Typography>
            <Typography paragraph>
